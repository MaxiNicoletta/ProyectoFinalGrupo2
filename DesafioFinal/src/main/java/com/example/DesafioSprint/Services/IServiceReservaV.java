...
public interface IServiceReservaV {
    ...
    FlightResponseDTO updateFlightReservation(Long id, ReservasVueloRequestDTO reservasVueloRequestDTO) throws VuelosException, PersonasException, UbicacionException;
